...
class UnAuthorizedException extends HttpException {
    constructor(statusCode, message) {
        super(statusCode || http_status_constant_1.HTTP_STATUS.UNAUTHORIZED.CODE, message || http_status_constant_1.HTTP_STATUS.UNAUTHORIZED.MESSAGE);
...
class NotFoundException extends HttpException {
    constructor(statusCode, message) {
        super(statusCode || http_status_constant_1.HTTP_STATUS.NOT_FOUND.CODE, message || http_status_constant_1.HTTP_STATUS.NOT_FOUND.MESSAGE);
...
class BadRequestException extends HttpException {
    constructor(statusCode, message) {
        super(statusCode || http_status_constant_1.HTTP_STATUS.BAD_REQUEST.CODE, message || http_status_constant_1.HTTP_STATUS.BAD_REQUEST.MESSAGE);
...
class DatabaseException extends HttpException {
    constructor(statusCode, message) {
        super(statusCode || http_status_constant_1.HTTP_STATUS.DATABASE_ERROR.CODE, message || http_status_constant_1.HTTP_STATUS.DATABASE_ERROR.MESSAGE);
